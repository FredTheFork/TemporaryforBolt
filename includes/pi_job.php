...
<head>
    ...
    .pi-safety-modal.active {
        display: flex;
    }
    .pi-safety-modal-content {
        background: white;
        border-radius: 8px;
        max-width: 600px;
        width: 90%;
    ...
    .pi-safety-modal-header h2 {
        margin: 0;
        font-size: 1.25rem;
    }
    .pi-safety-modal-close {
        background: none;
        border: none;
        font-size: 1.5rem;
        cursor: pointer;
    ...
    .pi-safety-modal-body {
        padding: 1.5rem;
    }
    .pi-safety-modal-footer {
        padding: 1rem 1.5rem;
                        ...
                        <div class="job-content-panels">
                            ...
                            <div class="job-tab-panel" id="job-tab-safety">
                                <div class="pi-safety-module" data-job-id="<?php echo esc_attr($job_id); ?>">
                                    ...
                                    <!-- Incident Modal -->
                                    <div class="pi-safety-modal" id="pi-incident-modal">
                                        <div class="pi-safety-modal-content">
                                            <div class="pi-safety-modal-header">
                                                <h2>Report Incident</h2>
                                                <button class="pi-safety-modal-close">&times;</button>
                                            </div>
                                            <div class="pi-safety-modal-body">
                                            ...
                                            <div class="pi-safety-modal-footer">
                                    ...
                                    <!-- Observation Modal -->
                                    <div class="pi-safety-modal" id="pi-observation-modal">
                                        <div class="pi-safety-modal-content">
                                            <div class="pi-safety-modal-header">
                                    ...
                                    <!-- Permit Modal -->
                                    <div class="pi-safety-modal" id="pi-permit-modal">
                                        <div class="pi-safety-modal-content">
                                            <div class="pi-safety-modal-header">
                                    ...
                                    <!-- JHA Modal -->
                                    <div class="pi-safety-modal" id="pi-jha-modal">
                                        <div class="pi-safety-modal-content">
                                            <div class="pi-safety-modal-header">
                                    ...
                                    <!-- Toolbox Talk Modal -->
                                    <div class="pi-safety-modal" id="pi-toolbox-talk-modal">
                                        <div class="pi-safety-modal-content">
                                            <div class="pi-safety-modal-header">
                                    ...
                                    <div class="pi-safety-modal" id="pi-inspection-modal">
                                        <div class="pi-safety-modal-content">
                                            <div class="pi-safety-modal-header">
                                    ...
                                    <div class="pi-safety-modal" id="pi-inspection-execute-modal">
                                        <div class="pi-safety-modal-content">
                                            <div class="pi-safety-modal-header">
                                    ...
                                    <div class="pi-safety-modal" id="pi-incident-detail-modal">
                                        <div class="pi-safety-modal-content">
                                            <div class="pi-safety-modal-header">
                                    ...
                                    <div class="pi-safety-modal" id="pi-observation-resolve-modal">
                                        <div class="pi-safety-modal-content">
                                            <div class="pi-safety-modal-header">
                                    ...
                                    <div class="pi-safety-modal" id="pi-permit-approve-modal">
                                        <div class="pi-safety-modal-content">
                                            <div class="pi-safety-modal-header">
                                    ...
                                    <!-- Permit Extend Modal -->
                                    <div class="pi-safety-modal" id="pi-permit-extend-modal">
                                        <div class="pi-safety-modal-content">
                                            <div class="pi-safety-modal-header">
                                                <h2>Extend Permit</h2>
                                                <button class="pi-safety-modal-close">&times;</button>
                                    ...
                                    <div class="pi-safety-modal" id="pi-jha-acknowledge-modal">
                                        <div class="pi-safety-modal-content">
                                            <div class="pi-safety-modal-header">
                                    ...
                                    <div class="pi-safety-modal" id="pi-toolbox-talk-attendance-modal">
                                        <div class="pi-safety-modal-content">
                                            <div class="pi-safety-modal-header">
                                    ...
                                    <!-- PPE Issue Modal -->
                                    <div class="pi-safety-modal" id="pi-ppe-issue-modal">
                                        <div class="pi-safety-modal-content">
                                            <div class="pi-safety-modal-header">
                                                <h2>Issue PPE</h2>
                                                <button class="pi-safety-modal-close">&times;</button>
                                    ...
                                    <!-- PPE Inspect Modal -->
                                    <div class="pi-safety-modal" id="pi-ppe-inspect-modal">
                                        <div class="pi-safety-modal-content">
                                            <div class="pi-safety-modal-header">
                                                <h2>Inspect PPE</h2>
                                                <button class="pi-safety-modal-close">&times;</button>
